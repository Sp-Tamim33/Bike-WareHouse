        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com" className="flex items-center">
                            <h1 className='text-3xl md:text-4xl text-white py-10 font-serif font-semibold'><span className='text-orange-500'>B</span>ike <span className='text-orange-500'>W</span>arehouse</h1>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="home" className="hover:underline">Bikes</a>
                                </li>
                                <li>
                                    <a href="home" className="hover:underline">See Bikes</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline"> Bike Warehouse ™</a>. All Rights Reserved.
                    </span>
